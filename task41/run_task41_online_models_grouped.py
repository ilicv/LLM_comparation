# run_task41_online_models_grouped.py
...
# ---- Config ------------------------------------------------------------------
RESULTS_BASE = "results_task41_online"
...
# Prompt files for Task 41 (DE, EN, SR)
PROMPT_DIR = "prompts_task41"
PROMPT_FILES = [
...
for provider, cfg in PROVIDERS.items():
    ...
    for model_name in cfg["models"]:
        print(f"\n?? Running Task41 on provider: {provider}  model: {model_name}")
        ...
        for prompt_file in PROMPT_FILES:
            ...
            prefix = f"results_{stem}_task41_"
