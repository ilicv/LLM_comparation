# run_task3a_online_models_grouped.py
...
# ---- Config ------------------------------------------------------------------
RESULTS_BASE = "results_task3a_online"
...
for provider, cfg in PROVIDERS.items():
    ...
    for model_name in cfg["models"]:
        print(f"\n?? Running Task3a on provider: {provider}  model: {model_name}")
        ...
        for prompt_file in PROMPT_FILES:
            ...
            prefix = f"results_{stem}_task3a_"
